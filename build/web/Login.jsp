<%-- 
    Document   : Login
    Created on : Apr 18, 2022, 6:29:23 PM
    Author     : Khoa
--%>
    ...
    <body>
        <div id="logreg-forms">
            <form class="form-signin" action="LoginControll" method="post">
                ...
                <input name="user"  type="text" id="inputEmail" class="form-control" placeholder="SÐT" required="" autofocus="">
            ...
            <form action="SignupControll" method="post" class="form-signup">
                ...
                <input name="SDT" type="text" id="SDT" class="form-control" placeholder="SÐT" required="" autofocus="">
