<%-- 
    Document   : EditAccountKH
    Created on : May 7, 2022, 9:25:53 PM
    Author     : Khoa
--%>
                        ...
                        <form action="EditAccountKH" method="post">
                            ...
                            <div class="modal-body">					
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>Họ tên</label>
                                        <input value="${listA.hoten}" name="hoten" type="text" class="form-control"   required>
                                        </div>
                                    <div class="form-group">                                  
                                    ...
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input value="${listA.email}" name="email" type="text" class="form-control"   required>
                                    </div>
                                    <div class="form-group ">
                                        <label>Điện thoại</label>
                                        <input value="${listA.dienthoai}"name="dienthoai" type="text" class="form-control"  required>
                                    </div>
                                </div>
