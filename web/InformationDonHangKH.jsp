<%-- 
    Document   : InformationDonHangKH
    Created on : May 19, 2022, 12:11:41 AM
    Author     : Khoa
--%>
                    ...
                    <div class="modal-content">
                        <form action="InformationDonHang" method="#">
                            <div class="modal-header">						
                                ...
                                <a class="close" href="DonHangKH?maac=${sessionScope.acc.maacc}" type="button" class="btn btn-success" aria-hidden="true" >x</a>
                            </div>
                            ...
                            <div class="modal-footer">
                                        <a class="navbar-brand" href="DonHangKH?maac=${sessionScope.acc.maacc}" type="button" class="btn btn-success" >Thoát</a>
                            </div>
                        </form>
                    </div>
                </div>
